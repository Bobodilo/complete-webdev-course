    import Web3 from 'web3'; //connect with ETh blockchain
    import { default as contract } from '../node_modules/truffle-contract/dist/truffle-contract'; //Eth contract abstraction for the browser to allow Smart contracts with JS methods
